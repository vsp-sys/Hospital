...
async function fetchHospitals() { const res = await api.get('/hospitals'); return res.data; }
async function fetchBranches() { const res = await api.get('/branches'); return res.data; }
async function fetchDoctors() { const res = await api.get('/doctors'); return res.data; }
async function fetchPatients() { const res = await api.get('/patients'); return res.data; }
...
async function fetchInvoices() { const res = await api.get('/invoices'); return res.data; }
import { 
...
export default function SuperAdminPanel({
  ...
  // Removed duplicate useState and useEffect for hospitals, branches, doctors, patients, appointments, prescriptions, invoices (already in props)
    // Removed duplicate useState for hospitals, branches, doctors, patients (already in props)
    // useEffect(() => {
